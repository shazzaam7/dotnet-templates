...
- **MyCustomTemplate**: Main application project containing Views, ViewModels, and UI-related logic
- **MyCustomTemplate.Core**: Core library containing all business logic, services, models, and utilities

All core logic should be placed in **MyCustomTemplate.Core** to facilitate easier implementation of features across different UI platforms (Desktop App, Fullscreen App, etc.).
...
- Place all business logic in **MyCustomTemplate.Core** project
...
- Use file-scoped namespaces:
  ```csharp
  namespace MyCustomTemplate.Core.Manage;
...
1. **Copy the template file**
   - Navigate to `source/MyCustomTemplate/Resources/Themes/`
...
3. **Register your theme**
   ...
   ```
   - Open `source/MyCustomTemplate/Services/ThemeService.cs`
   ...
   [Theme.MyCustom] = new ThemeConfiguration
   {
       ...
       ResourcePath = "avares://MyCustomTemplate/Resources/Themes/MyCustomTheme.axaml",
