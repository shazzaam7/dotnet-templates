...
public interface ISettingsService<T> where T : class, new()
{
    ...
    /// </summary>
    /// <returns>A task that represents the asynchronous operation. The result contains the loaded settings instance, or default settings if loading fails.</returns>
