...
{
    private static readonly MyCustomTemplateLogger _log = MyCustomTemplateLogger.For("LocalizationService");
    ...
    /// </summary>
    private static string _baseUri = "avares://MyCustomTemplate.GUI/Resources/Language/";
