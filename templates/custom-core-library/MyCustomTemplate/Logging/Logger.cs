...
using System.Text;
using MyCustomTemplate.Utilities;
using NLog;
using NLog.Config;
using NLog.Targets;
...
public static class Logger
{
    ...
    /// <summary>
    /// Flushes NLog's LogManager, ensuring logs are written before a potential crash
    /// </summary>
    ...
    // Static class logging (no generic type parameter needed)
    /// <summary>
    /// Logs a trace-level message with the calling method's context automatically captured.
    /// Ideal for use from static classes where passing a type parameter is awkward.
    /// </summary>
    /// <param name="message">The message to log.</param>
    /// <param name="memberName">The calling member name (automatically captured via CallerMemberName).</param>
    /// <param name="filePath">The calling file path (automatically captured via CallerFilePath).</param>
    /// <param name="lineNumber">The calling line number (automatically captured via CallerLineNumber).</param>
    ...
    /// <summary>
    /// Logs a debug-level message with the calling method's context automatically captured.
    /// Ideal for use from static classes where passing a type parameter is awkward.
    /// </summary>
    /// <param name="message">The message to log.</param>
    /// <param name="memberName">The calling member name (automatically captured via CallerMemberName).</param>
    ...
    /// <summary>
    /// Logs an info-level message with the calling method's context automatically captured.
    /// Ideal for use from static classes where passing a type parameter is awkward.
    /// </summary>
    /// <param name="message">The message to log.</param>
    /// <param name="memberName">The calling member name (automatically captured via CallerMemberName).</param>
    ...
    /// <summary>
    /// Logs a warning-level message with the calling method's context automatically captured.
    /// Ideal for use from static classes where passing a type parameter is awkward.
    /// </summary>
    /// <param name="message">The message to log.</param>
    /// <param name="memberName">The calling member name (automatically captured via CallerMemberName).</param>
    ...
    /// <summary>
    /// Logs an error-level message with the calling method's context automatically captured.
    /// Ideal for use from static classes where passing a type parameter is awkward.
    /// </summary>
    /// <param name="message">The message to log.</param>
    /// <param name="memberName">The calling member name (automatically captured via CallerMemberName).</param>
    ...
    /// <summary>
    /// Logs a fatal-level message with the calling method's context automatically captured.
    /// Ideal for use from static classes where passing a type parameter is awkward.
    /// </summary>
    /// <param name="message">The message to log.</param>
    /// <param name="memberName">The calling member name (automatically captured via CallerMemberName).</param>
    ...
    /// <summary>
    /// Formats the calling context into a readable string for logging.
    /// </summary>
    ...
    /// <returns>A formatted context string (e.g., "MyStaticClass.MyMethod:42").</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// and optionally system/environment information with automatic caller context capture.
    /// </summary>
    ...
    /// <param name="message">The message to log.</param>
    [Obsolete("Does not work from static classes. Use Logger.Trace(message) instead, which auto-captures caller context.")]
    ...
    /// <typeparam name="T">The type to use for class name resolution.</typeparam>
    /// <param name="message">The message to log.</param>
    [Obsolete("Does not work from static classes. Use Logger.Debug(message) instead, which auto-captures caller context.")]
    ...
    /// <typeparam name="T">The type to use for class name resolution.</typeparam>
    /// <param name="message">The message to log.</param>
    [Obsolete("Does not work from static classes. Use Logger.Info(message) instead, which auto-captures caller context.")]
    ...
    /// <typeparam name="T">The type to use for class name resolution.</typeparam>
    /// <param name="message">The message to log.</param>
    [Obsolete("Does not work from static classes. Use Logger.Warning(message) instead, which auto-captures caller context.")]
    ...
    /// <typeparam name="T">The type to use for class name resolution.</typeparam>
    /// <param name="message">The message to log.</param>
    [Obsolete("Does not work from static classes. Use Logger.Error(message) instead, which auto-captures caller context.")]
    ...
    /// <typeparam name="T">The type to use for class name resolution.</typeparam>
    /// <param name="message">The message to log.</param>
    [Obsolete("Does not work from static classes. Use Logger.Fatal(message) instead, which auto-captures caller context.")]
    ...
    /// <param name="ex">The exception to log.</param>
    /// <param name="includeEnvironmentInfo">Whether to include system information (machine name, OS version, etc.).</param>
    [Obsolete("Does not work from static classes. Use Logger.LogExceptionDetails(ex) instead, which auto-captures caller context.")]
